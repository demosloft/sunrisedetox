 ...
 */
			onAdd: function() {
				...
				var elem = $(document.createElement('div')).addClass("marker").append($('<p class="marker-text">'+(this.notes.length+1)+'</p>')).prepend($('<img>',{src: './assets/img/u5173.png', width:'100%'})).attr("title","");
				$(elem).tooltip({
					content: function() {
